...
const styles = StyleSheet.create({
  eyebrow: { color: colors.cyan, fontSize: 11, fontWeight: "700", letterSpacing: 1.8, textTransform: "uppercase" },
  rule: { height: 1, backgroundColor: colors.line, opacity: 0.9 },
  dot: { width: 7, height: 7, borderRadius: 4 },
  action: { minHeight: 44, justifyContent: "center" },
  actionText: { color: colors.inkSoft, fontSize: 14, fontWeight: "700" },
