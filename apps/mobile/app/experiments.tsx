...
const styles = StyleSheet.create({ screen: { padding: 20, gap: 14, backgroundColor: colors.room, paddingBottom: 48 }, kicker: { color: colors.cyan, fontSize: 11, fontWeight: "700", letterSpacing: 1.5 }, title: { color: colors.ink, fontSize: 28, fontWeight: "700" }, intro: { color: colors.inkMuted, lineHeight: 21 }, hint: { color: colors.inkMuted, fontSize: 12 }, input: { backgroundColor: colors.surface, color: colors.ink, borderRadius: 12, padding: 14, minHeight: 48 }, label: { color: colors.ink, fontWeight: "700" }, choices: { flexDirection: "row", gap: 8, flexWrap: "wrap" }, choice: { borderWidth: 1, borderColor: colors.lineStrong, borderRadius: 10, padding: 12 }, choiceSelected: { borderColor: colors.cyan, backgroundColor: colors.surface }, choiceText: { color: colors.ink }, button: { backgroundColor: colors.cyan, padding: 15, borderRadius: 12, alignItems: "center" }, disabled: { opacity: 0.4 }, buttonText: { color: colors.room, fontWeight: "700" }, error: { color: colors.danger }, section: { color: colors.ink, fontWeight: "700", marginTop: 14 }, card: { backgroundColor: colors.surface, padding: 16, borderRadius: 14, gap: 6 }, cardTitle: { color: colors.ink, fontSize: 17, fontWeight: "700" }, meta: { color: colors.inkMuted }, link: { color: colors.cyan, paddingVertical: 10 } });
